...
//
// NOTE(tiborvass): COPIED from go/internal/srcimporter
// available only in go1.9.
// types.SizesFor was also introduced in go1.9, therefore
// Importer.sizes is kept nil in New().
package srcimporter
